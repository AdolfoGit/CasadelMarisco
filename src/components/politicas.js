...
const Politicas = () => {
  ...
  return (
    <div className="aviso-privacidad">
      ...
      <h3 className='titulo'>Términos y Condiciones del Servicio</h3>

      <h5>1. Pedidos en Físico:</h5>
      <ul>
